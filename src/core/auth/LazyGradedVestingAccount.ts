...
import { BaseVestingAccount as BaseVestingAccount_pb } from '@terra-rebels/legacy.proto/cosmos/vesting/v1beta1/vesting';
import {
  LazyGradedVestingAccount as LazyGradedVestingAccount_pb,
  Schedule as Schedule_pb,
  VestingSchedule as VestingSchedule_pb,
} from '@terra-rebels/legacy.proto/terra/vesting/v1beta1/vesting';
